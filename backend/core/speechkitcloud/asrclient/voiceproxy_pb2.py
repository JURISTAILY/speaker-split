...
_CONNECTIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='disableAntimatNormalizer', full_name='VoiceProxyProtobuf.ConnectionRequest.disableAntimatNormalizer', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='advancedASROptions', full_name='VoiceProxyProtobuf.ConnectionRequest.advancedASROptions', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skipAudioFromLogging', full_name='VoiceProxyProtobuf.ConnectionRequest.skipAudioFromLogging', index=14,
      number=20, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='musicRequest', full_name='VoiceProxyProtobuf.ConnectionRequest.musicRequest', index=15,
