...
var DialogueItemComponent = (function () {
    function DialogueItemComponent() {
        this.open = false;
    }
    DialogueItemComponent.prototype.switchDetails = function () {
        this.open = !this.open;
    };
    __decorate([
        core_1.Input(), 
        __metadata('design:type', models_1.Call)
    ], DialogueItemComponent.prototype, "call", void 0);
    DialogueItemComponent = __decorate([
        core_1.Component({
    ...
    return DialogueItemComponent;
}());
exports.DialogueItemComponent = DialogueItemComponent;
//# sourceMappingURL=dialogue-item.component.js.map